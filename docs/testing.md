...
- GPS feedback and RC-link loss handling are now covered by `test_gps_navigation` and `test_rc_failsafe`.
- The next test expansion areas are richer estimator noise models, RC/motor HAL behavior, and mission-state handling.
